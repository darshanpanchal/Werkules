...
//        }
    ...
    private func userIndexPath(userID: UInt) -> IndexPath? {
        guard let index = users.firstIndex(where: { $0.userID == userID }), index != NSNotFound else {
...
extension CallViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: CallConstant.opponentCollectionViewCellIdentifier, for: indexPath) as? UserCellView else {
