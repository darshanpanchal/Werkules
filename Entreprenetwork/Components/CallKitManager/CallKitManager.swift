...
class CallKitManager: NSObject {
    ...
    class func configuration() -> CXProviderConfiguration {
        let _ = Bundle.main.infoDictionary?["CFBundleDisplayName"] as? String
        let config = CXProviderConfiguration.init()//CXProviderConfiguration(localizedName: appName ?? "")
        //config.localizedName = appName
