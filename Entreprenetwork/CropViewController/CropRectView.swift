...
//        resizeImageView.image = image?.resizableImage(withCapInsets: UIEdgeInsets(top: 23.0, left: 23.0, bottom: 23.0, right: 23.0))
    ...
    override func layoutSubviews() {
        ...
        topRightCornerView.layer.cornerRadius = bottomLeftCornerView.frame.width / 2.0
        topRightCornerView.clipsToBounds = true
        topRightCornerView.backgroundColor = UIColor.white
        topLeftCornerView.layer.cornerRadius = bottomLeftCornerView.frame.width / 2.0
        topLeftCornerView.clipsToBounds = true
        topLeftCornerView.backgroundColor = UIColor.white
        ...
        bottomLeftCornerView.layer.cornerRadius = bottomLeftCornerView.frame.width / 2.0
        bottomLeftCornerView.clipsToBounds = true
        bottomLeftCornerView.backgroundColor = UIColor.white
        ...
        bottomRightCornerView.layer.cornerRadius = bottomLeftCornerView.frame.width / 2.0
        bottomRightCornerView.clipsToBounds = true
        bottomRightCornerView.backgroundColor = UIColor.white
