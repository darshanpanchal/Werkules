...
public class AEOTPTextField: UITextField {
    ...
    public var otpFilledBackgroundColor: UIColor = UIColor.white//UIColor(red: 0.949, green: 0.949, blue: 0.949, alpha: 1)
    public var otpCornerRaduis: CGFloat = 10
    public var otpDefaultBorderColor: UIColor = .black
    public var otpFilledBorderColor: UIColor = .black
    public var otpDefaultBorderWidth: CGFloat = 2
    public var otpFilledBorderWidth: CGFloat = 2
    public var otpTextColor: UIColor = .black
    public var otpFontSize: CGFloat = 17
    public var otpFont: UIFont = UIFont.init(name: "Avenir-Heavy", size: 17.0)!
